...
use Modules\Order\Console\AbandonedCartClearCommand;
use Modules\Order\Console\AbandonedCartNotifyCommand;
...
class OrderServiceProvider extends ServiceProvider
{
    ...
    public function register()
    {
        ...
        $this->commands([
            AbandonedCartClearCommand::class,
            AbandonedCartNotifyCommand::class
        ]);
