  ...
  <div>
    <div class="p-6 sm:px-20 bg-white border-b border-gray-200">
      ...
      <div class="mt-6 text-gray-500">
        Laravel Jetstream provides a beautiful,
        robust starting point for your next Laravel application.
        Laravel is designed to help you build your application
        using a development environment that is simple, powerful,
        and enjoyable. We believe you should love expressing your
        creativity through programming, so we have spent time carefully crafting the Laravel
      ...
      <div class="p-6">
        <div class="flex items-center">
          ...
          >
            ...
            18.477 5.754 18 7.5 18s3.332.477 4.5 1.253m0-13C13.168
        ...
        <div class="ml-12">
          <div class="mt-2 text-sm text-gray-500">
            ...
            every aspect of the framework. Whether you're new to
            the framework or have previous experience,
            ...
            <div class="mt-3 flex items-center text-sm font-semibold text-indigo-700">
              ...
              <div class="ml-1 text-indigo-500">
                ...
                ><path
                  ...
                  0l6 6a1 1 0 010 1.414l-6 6a1 1 0
      ...
      <div class="p-6 border-t border-gray-200 md:border-t-0 md:border-l">
          ...
          >
            <path
              d="M3 9a2 2 0 012-2h.93a2 2 0
                001.664-.89l.812-1.22A2 2 0 0110.07
                4h3.86a2 2 0 011.664.89l.812 1.22A2 2 0
                0018.07 7H19a2 2 0 012 2v9a2 2 0 01-2 2H5a2
                2 0 01-2-2V9z"
            />
            <path
              d="M15 13a3 3 0
        ...
        <div class="ml-12">
          <div class="mt-2 text-sm text-gray-500">
            ...
            Laravel, PHP, and JavaScript development.
            Check them out, see for yourself, and massively
      ...
      <div class="p-6 border-t border-gray-200">
        ...
        <div class="ml-12">
          <div class="mt-2 text-sm text-gray-500">
            ...
            framework that doesn't get in your way. You'll be amazed how easily you
            can build and maintain fresh, modern designs with this wonderful
      ...
      <div class="p-6 border-t border-gray-200 md:border-l">
        ...
        <div class="ml-12">
          <div class="mt-2 text-sm text-gray-500">
            ...
            Jetstream, as well as support for user email verification
            and resetting forgotten passwords. So, you're free to get
            started what matters most: building your application.
          </div>
        </div>
      </div>
    </div>
