  ...
  <jet-action-section>
    ...
    <template #content>
      <div class="max-w-xl text-sm text-gray-600">
        ...
        Some of your recent sessions are listed below; however,
        this list may not be exhaustive. If you feel
      ...
      <!-- IntegrationLog Out Other Devices Confirmation Modal -->
      <jet-dialog-modal
